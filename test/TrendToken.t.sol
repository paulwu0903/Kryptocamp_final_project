...
contract TrendTokenTest is Test {
    ...
    function testTransfer() public {
        ...
        trendToken.publicMint{value: 100 ether}(15 ether);
        assertEq(trendToken.balanceOf(address(0x6337c10F0DfcE4f813306f577A04c42132F7dCb2)), 15 ether);

        trendToken.transfer(address(0xE7918DBc151Bf711d7E2DFe8d19F686B2938A7AF), 5 ether);
        assertEq(trendToken.balanceOf(0xE7918DBc151Bf711d7E2DFe8d19F686B2938A7AF), 15 ether);
        vm.stopPrank();
    ...
    function testSnapshot() public {
        ...
        vm.startPrank(0xb8A813833b6032b90a658231E1AA71Da1E7eA2ed);
        snapshotId = trendToken.snapshot();
        console.log("snapshot: ", snapshotId);
        vm.stopPrank();

        vm.startPrank(0xE7918DBc151Bf711d7E2DFe8d19F686B2938A7AF);
        trendToken.publicMint{value: 100 ether}(10 ether);
        assertEq(trendToken.balanceOf(address(0xE7918DBc151Bf711d7E2DFe8d19F686B2938A7AF)), 25 ether);
        vm.stopPrank();

        assertEq(trendToken.balanceOfAt(address(0xE7918DBc151Bf711d7E2DFe8d19F686B2938A7AF), snapshotId), 15 ether);
    }
